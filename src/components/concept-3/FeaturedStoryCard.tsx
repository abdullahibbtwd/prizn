...
export function FeaturedStoryCard({ lang, onOpenStory }: FeaturedStoryCardProps) {
  const story = journalContent.featuredStory
  ...
  return (
    <section id="featured-story" className="bg-[#FDFBF7] py-20 md:py-32 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Massive Card - Like a Magazine Cover */}
        <motion.div
          ...
          onClick={onOpenStory}
          className="group relative cursor-pointer overflow-hidden rounded-[16px] border border-[#EAE6DF] bg-white shadow-[0_4px_24px_rgba(0,0,0,0.03)] transition-all duration-500 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)]"
        >
